...
import { FormDataType } from '@/pages/auth/login';
...
export interface LoginProps {
  ...
  onSubmit?: (error: unknown, values: FormDataType) => void;
  className?: string;
...
class Login extends Component<LoginProps, LoginState> {
  ...
  public static MobileNumber: React.FunctionComponent<LoginItemProps>;

  public static SmsCaptcha: React.FunctionComponent<LoginItemProps>;
